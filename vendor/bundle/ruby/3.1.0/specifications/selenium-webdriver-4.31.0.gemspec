# -*- encoding: utf-8 -*-
# stub: selenium-webdriver 4.31.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.60", ">= 1.60.2"])
    ...
    s.add_dependency(%q<git>.freeze, ["~> 1.19"])
    s.add_dependency(%q<rack>.freeze, ["~> 2.0"])
    s.add_dependency(%q<rake>.freeze, ["~> 13.0"])
    s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 1.60", ">= 1.60.2"])
    ...
    s.add_dependency(%q<yard>.freeze, ["~> 0.9.11", ">= 0.9.36"])
  end
end
